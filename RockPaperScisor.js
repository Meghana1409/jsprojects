...
else if(userchoice === compschoice) {
    console.log( "Tie!");
}
else if(userchoice === "rock" && compschoice === "paper") {
    console.log ("You lose, computer picked " +  compschoice);
}
else if(userchoice === "paper" && compschoice === "scissor") {
    console.log ("You lose, computer picked " +  compschoice);
}
else if(userchoice === "scissor" && compschoice === "rock") {
    console.log ("You lose, computer picked " +  compschoice);
}
else{
